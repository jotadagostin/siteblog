...
type ErrorBundaryProps = {
  error: Error;
  reset: () => void;
};

export default function ErrorBundary({ error, reset }: ErrorBundaryProps) {
  return (
    <div className="min-h-[400px] flex items-center justify-center p-4">
      <div className="max-w-md w-full text-center">
        <div className="relative inline-block mb-6">
          <AlertTriangle className="text-gray-100 mx-auto" size={60} />
        ...
        <h2 className="text-heading-xl text-white font-sans">
